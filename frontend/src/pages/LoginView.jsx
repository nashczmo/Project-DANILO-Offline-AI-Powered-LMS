...
export default memo(function LoginView({ form, onChange, onSubmit, loading, error }) {
  return (
      ...
      >
        ...
        <div className="relative z-10 text-center flex flex-col items-center px-8 max-w-lg">
          ...
          <div className="mt-10 flex items-center gap-6 flex-wrap justify-center">
            {[
              { label: "Offline-first", color: "bg-danilo-success" },
              { label: "AI-powered", color: "bg-danilo-primary" },
              { label: "DepEd-aligned", color: "bg-danilo-secondary" },
            ].map(({ label, color }) => (
