  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <div className="relative">
        <select id={id} className="dn-input appearance-none pr-10" {...props}>
          {children}
        </select>
        <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none text-[#5F6368]">
