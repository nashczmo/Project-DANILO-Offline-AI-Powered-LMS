...
<style>body{font-family:Inter,system-ui,sans-serif;background:#f8fafc;color:#334155;display:flex;align-items:center;justify-content:center;min-height:100dvh;margin:0}main{text-align:center;padding:2rem}h1{font-size:1.25rem;font-weight:600;margin-bottom:0.5rem}p{font-size:.875rem;color:#64748b;margin:0}</style>
