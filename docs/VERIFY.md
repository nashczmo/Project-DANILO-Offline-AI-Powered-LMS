...
Default installs use Ollama and should show the hardware-selected model from `/opt/danilo/app/.env` or a local `danilo-phi4-mini` GGUF-backed Ollama model when a custom GGUF was registered.
