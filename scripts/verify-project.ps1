...
Require-Text "lib\frontend.sh" "Installing DANILO frontend source files" "generated frontend source of truth"
Require-Text "frontend\src\api.js" "apiUpload" "frontend upload client"
...
Require-Text "frontend\vite.config.js" "base: `"/`"" "Vite base path is absolute root"
...
Require-Text "frontend\src\main.jsx" "ErrorBoundary" "frontend runtime error boundary"
Require-Text "frontend\src\main.jsx" "console.info\(\""\[DANILO\] frontend mount starting" "frontend mount debug logging"
Require-Text "frontend\src\App.jsx" 'apiRequest\("/auth/login"' "frontend login uses normalized API route"
Require-Text "frontend\public\sw.js" "DANILO is offline" "service worker offline fallback UI"
Require-Text "frontend\public\sw.js" "\[`"/icons/`", `"/assets/`", `"/fonts/`"\]" "service worker caches static asset prefixes"
Require-Text "frontend\src\App.jsx" "Generate Lesson From Material" "teacher upload UI"
Require-Text "lib\ai.sh" "danilo-phi4-mini" "custom Phi-4 Mini GGUF model registration"
Require-Text "lib\ai.sh" "phi4-mini" "default Ollama classroom model"
