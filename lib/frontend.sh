...
validate_frontend_files() {
  ...
  validate_generated_file "${APP_ROOT}/frontend/src/components/ui/ErrorBoundary.jsx" "frontend error boundary"

  # Layout components
  validate_generated_file "${APP_ROOT}/frontend/src/components/layout/AppLayout.jsx" "frontend app layout"
  ...
  validate_generated_file "${APP_ROOT}/frontend/src/portals/student/StudentAssignments.jsx" "frontend student assignments"
  ...
  validate_generated_file "${APP_ROOT}/frontend/src/portals/teacher/TeacherInsights.jsx" "frontend teacher insights"

  # Common infrastructure
  validate_generated_file "${APP_ROOT}/frontend/src/hooks/useApi.js" "frontend API hook"
