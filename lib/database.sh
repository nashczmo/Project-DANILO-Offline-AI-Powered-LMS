...
generate_secrets() {
  ...
  OLLAMA_MODEL="${DANILO_OLLAMA_MODEL:-${OLLAMA_MODEL:-gemma3:1b}}"
...
DANILO_AI_PRIMARY_MODEL=${DANILO_DEFAULT_OLLAMA_MODEL:-gemma3:1b}
DANILO_AI_FALLBACK_MODEL=${DANILO_FALLBACK_OLLAMA_MODEL:-tinyllama:1.1b-chat}
DANILO_AI_OPTIONAL_MODEL=${DANILO_OPTIONAL_OLLAMA_MODEL:-qwen2.5:1.5b}
