...
generate_secrets() {
  ...
  PORTAL_DOMAIN="${DANILO_PORTAL_DOMAIN:-${PORTAL_DOMAIN:-danilo.edu}}"
...
DANILO_AI_MODEL_MID=${DANILO_AI_MODEL_MID:-${DANILO_AI_MODEL_BALANCED:-qwen2.5:7b}}
DANILO_AI_MODEL_BALANCED=${DANILO_AI_MODEL_BALANCED:-qwen2.5:7b}
