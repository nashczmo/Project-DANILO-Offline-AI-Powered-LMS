...
DHCP_RANGE_START="${DANILO_DHCP_RANGE_START:-10.10.0.10}"
DHCP_RANGE_END="${DANILO_DHCP_RANGE_END:-10.10.0.200}"
PORTAL_DOMAIN="${DANILO_PORTAL_DOMAIN:-danilo.apc.edu.ph}"
SSID="${DANILO_SSID:-PROJECT-DANILO}"
WIFI_PASSPHRASE="${DANILO_WIFI_PASSPHRASE:-}"
DANILO_AI_RUNTIME="ollama"
OLLAMA_MODEL="${DANILO_OLLAMA_MODEL:-auto}"
DANILO_SEED_DEMO="${DANILO_SEED_DEMO:-1}"
...
NODE_MAJOR="${DANILO_NODE_MAJOR:-20}"
